...
<body>
    ...
    <fieldset class="center">
        <div class="band">
            <figcaption style="margin-left: 12%;font-size: 20px;font-family:plein2;">Formulaire d'Enregistrement</figcaption>
        </div>
        <div class="input">
...
$donnes = [                             # juste "/register" pour l'URL. C'est les trois façons qu'a n'a pu connaitre après vos aides de debug,ceci par défaut marche bien ici
    ...
    try {
    $response = $client->request('POST','/back-end/systeme-auth/register', [
     "json" => $donnes
    ]);
    ...
    $_SESSION["donnees_justes"] = true;         
    ?>
    <p>Inscription réussie; <a href="login.php">Connectez-vous!</a></p>
    <?php
